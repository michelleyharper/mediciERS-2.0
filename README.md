...
This project includes a significant enhancement of the first Medici Expense Reimbursement System that I created. The application was fully converted in the backend from Javalin to Hibernate / Spring and the front end features a major design overhaul to transform the overall look and feel of the application. I was assigned team lead for this project and was responsible for managing the workflow of each sprint, identifying and coordinating assignments, and maintaining the source code in our working repository. The final product includes the unit testing done by contributors mentioned below. 
